...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    useRouteMatch is used to change a part of the client side routing of a URL without needing to change the entire URL. It's primary use is for nested routes, i.e. 'blank.com/a' to 'blank.com/a/b'. 
    
1. How would you explain form validation to someone who has never programmed before?
    Form validation is the apps way of making sure you put in the correct information. Like when siging up for a website the app will tell you if you've entered anything besides an email in the email field, or it will make sure you've checked the terms and conditions before moving forward.

1. In 1-2 sentences, define end to end testing.
    End to end testing is essentialy trying to replicate the full experience of using an app in a controlled environment. It test the app for all functionality it will be expected to have in a live setting and will be tested for potential bugs or errors that would harm the user experience.
